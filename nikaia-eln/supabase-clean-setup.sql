-- ============================================
-- NIKAIA ELN - NETTOYAGE ET RECRÉATION
-- ============================================
-- Ce script nettoie TOUTES les policies avant de recréer
-- ============================================
...
DECLARE
    r RECORD;
BEGIN
    -- Supprimer toutes les policies de toutes les tables
    FOR r IN (
...
-- ============================================
-- ÉTAPE 7: CRÉER LES POLICIES (après nettoyage)
-- ============================================
...
-- Policies Storage (simplifiées - sans vérifier entity_type)
